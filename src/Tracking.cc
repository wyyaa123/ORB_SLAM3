...
namespace ORB_SLAM3
{
    ...
    Sophus::SE3f Tracking::GrabImageRGBD(const cv::Mat &imRGB, const cv::Mat &imD, const cv::Mat &imSem, const double &timestamp, string filename)
    {
        mImGray = imRGB;
        cv::Mat imDepth = imD;
        cv::Mat imSemantics = imSem;
