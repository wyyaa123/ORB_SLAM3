...
namespace ORB_SLAM3
{
    ...
    void Viewer::Run()
    {
        ...
        pangolin::Var<bool> menuShowBezierCurves("menu.Show Bezier Curves", true, true);
        ...
        cv::namedWindow("ORB-SLAM3: Current Frame Semantic Mask");
        ...
        while (1)
        {
            ...
            if (menuShowBezierCurves)
                mpMapDrawer->DrawBezierCurves();
