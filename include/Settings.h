...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        float edgeMinDepth() { return edgeMinDepth_; }
        float edgeCullMinDepth() { return edgeCullMinDepth_; }
        float edgeMaxDepth() { return edgeMaxDepth_; }
        float edgeMinValidRatio() { return edgeMinValidRatio_; }
    ...
    private:
        ...
        void readEdge(cv::FileStorage &fSettings);
        ...
        float edgeMinDepth_;
        float edgeCullMinDepth_;
        float edgeMaxDepth_;
        float edgeMinValidRatio_;
    };
};
