...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // New function to process RGB-D frames with semantic information (e.g. from a semantic segmentation network)
        Sophus::SE3f TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const cv::Mat &sem, const double &timestamp, const vector<IMU::Point> &vImuMeas = vector<IMU::Point>(), string filename = "");
