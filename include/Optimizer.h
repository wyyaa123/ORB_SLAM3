...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        int static PoseInertialOptimizationLastKeyFrameWithCurve(Frame *pFrame, bool bRecInit = false);
        int static PoseInertialOptimizationLastFrame(Frame *pFrame, bool bRecInit = false);
        int static PoseInertialOptimizationLastFrameWithCurve(Frame *pFrame, bool bRecInit = false);
